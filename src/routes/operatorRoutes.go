...
func SetupOperatorRoutes(adminGroup *gin.RouterGroup, _ *gorm.DB) {
	...
	operatorGroup.POST("/briefings", controllers.CreateOperatorBriefing)
	...
	operatorGroup.GET("/investigations/:id/evidence", controllers.ListOperatorInvestigationEvidence)
	operatorGroup.GET("/tasks", controllers.ListOperatorTasks)
